...
st.header('Input Values for Grid')
pmin = st.number_input(f'Enter minimum {x_col1} value', min_value=0.0, max_value=0.5, step=0.005)
pmax = st.number_input(f'Enter maximum {x_col1} value', min_value=0.0, max_value=0.5, step=0.005)
dmMin = st.number_input(f'Enter minimum {x_col2} value', min_value=0.0, max_value=0.2, step=0.005)
dmMax = st.number_input(f'Enter maximum {x_col2} value', min_value=0.0, max_value=0.2, step=0.005)
step_size = st.number_input('Enter step size', min_value=0.0, max_value=0.5,  step=0.005)
